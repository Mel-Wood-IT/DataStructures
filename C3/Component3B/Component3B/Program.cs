...
namespace Component3B
{
    internal class Program
    {
        ...
        #region MainMenu
        // Display menu for the user to select from
        static int MainMenu()
        {
            Console.Clear();
        ...
        static void MainMenuOutput(int opt)
        {
            ...
            // Check to see if folder is empty and then adds it to the base directory
            if (!string.IsNullOrEmpty(folder))
            {
                string fullPath = Path.Combine(BaseDirectory, folder);
                FileMenuOutput(fullPath);
            }
        }
        #endregion
        ...
        static int DisplaySubMenu()
        {
            ...
            while (option < 1 || option > 8)
            {
                ...
                Console.WriteLine("[6] - Time Complexity");
        ...
        static void PreOrderOp()
        {
            ...
            string printPreOrder = avlTree.PreOrder();
        ...
        static void PostOrderOp()
        {
            ...
            string printPostOrder = avlTree.PostOrder();
        ...
        static void InOrderOp()
        {
            ...
            string printInOrder = avlTree.InOrder();
        ...
        static void InsertOp()
        {
            ...
            string wordInsert = avlTree.InsertAdd(insertWord, insertWord.Length);
        ...
        static void FindOp()
        {
            ...
            string wordFound = avlTree.Find(findWord);
        ...
        static void DeleteOp()
        {
            ...
            string wordToDelete = avlTree.Remove(deleteWord);
        ...
        static void Detail()
        {
            ...
            string showDetails = avlTree.Details();
        ...
        static void Demonstration()
        {
            ...
            string invalidInsert = avlTree.InsertAdd("#Hello", 6);
            Console.WriteLine(invalidInsert);
            Console.WriteLine("Press any key to continue...");
            Console.ReadKey();
            // Insert a duplicate that cant be added
            Console.WriteLine("Insert duplicate word 'able'");
            string dupeInsert = avlTree.InsertAdd("able", 4);
            Console.WriteLine(dupeInsert);
            Console.WriteLine("Press any key to continue...");
            Console.ReadKey();
            // Insert a word that can be added
            Console.WriteLine("Insert 'Forget'");
            string wordInsert = avlTree.InsertAdd("Forget", 6);
            Console.WriteLine(wordInsert);
            Console.WriteLine("Press any key to continue...");
            Console.ReadKey();
            ...
            string invalidDelete = avlTree.Remove(deleteInvalid);
            ...
            string notFound = avlTree.Find(invalidWord);
            Console.WriteLine(notFound);
            Console.WriteLine("Press any key to continue...");
            Console.ReadKey();

            Console.WriteLine("Find word that does exist 'action'");
            string findWord = "action";
            string wordFound = avlTree.Find(findWord);
            Console.WriteLine(wordFound);
